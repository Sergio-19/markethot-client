    ...
    return (
        <Layout>
           <div className="info__wrapper">
                ...
                <div className="info__text">
                <p>Оплата усуществляется картой на сайте платёжной системы https://yookassa.ru/. После оплаты на указанный вами электронный адрес будет отправлен чек, подтверждающий оплату заказа. 
                    </p>
                </div>
                <div className="info__title">
                ...
                <div className="info__text">
                <p>В случае если доставленный товар оказался бракованным, либо не соответствует заявленным на сайте характеристикам, вы всегда можете оформить возврат товара. Для возврата товара перейдите в раздел Контакты и напишите нашему менеджеру, далее вы получите все необходимые инструкции.
                    </p>
                </div>
           </div>
        </Layout>
